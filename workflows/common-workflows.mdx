...
3. **Integrations** - Connect Google Workspace or HubSpot via [**Settings**](https://every.ai/settings) → **Integrations**
...
5. **Create Offerings** - Set up all services/products with standard rates in [**Offerings**](https://every.ai/offerings)
