...
**Week 1: Foundation**
1. **Organization Setup** - Complete business profile, upload logo, set currency and payment terms, configure tax rate in [**Settings**](https://every.ai/settings)
2. **Payment Processing** - Connect and verify Stripe account via [**Settings**](https://every.ai/settings) → **Payments**
3. **Integrations** - Connect Google Workspace via [**Settings**](https://every.ai/settings) → **Integrations**, then add Xero, HubSpot, or Granola in [**Agent Settings → Integrations**](https://every.ai/agent/settings/integrations)
4. **Add Clients** - Create manually in [**Clients**](https://every.ai/clients), use Google contact suggestions/Scan Contacts, then run client enrichment
5. **Create Services and Products** - Set up your reusable catalog in [**Services**](https://every.ai/services) and [**Products**](https://every.ai/products)
...
<Tip>
  **Ask Every Agent:** Streamline your entire business setup:
  ...
  - "Create services for my standard work: hourly consulting at $150/hour, monthly retainer at $5000/month, and project management at $200/hour"
  - "Scan my Google contacts and categorize them by business type"
</Tip>

**Week 2: First Invoice**
6. **Create First Invoice** - Select client, add saved services/products or manual line items, review appearance, test before sending
...
2. Create invoice with products from your product catalog
...
**For Wholesale:** Use your product catalog, automations for regular orders, volume discounts, and Net 30 terms.
