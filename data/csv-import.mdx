...
Every Agent will include a powerful CSV import wizard that can import hundreds or thousands of records from spreadsheets - perfect for migrating from another system or bulk-loading data.
