---
title: "Import Data (CSV, Excel, Word)"
description: "Import data from spreadsheets and documents using Every Agent - supports CSV, Excel (XLS, XLSX), and Word (DOCX) files"
icon: "file-import"
---
