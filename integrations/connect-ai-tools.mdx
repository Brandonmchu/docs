...
### The Admin MCP connector

Every runs an MCP server for business owners:

| Connector | Who it's for | URL | What it does |
|-|-|-|-|
| **Admin MCP** | You (the business owner) | `https://admin-mcp.every.ai` | Your full Every toolset — create/send invoices, manage clients and contacts, proposals, payments, expenses, and ask the Every Assistant — from inside your own AI assistant |

This page covers the **Admin MCP** (connecting your own AI assistant).
