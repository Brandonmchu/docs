...
Go to [**Settings**](https://app.every.ai/settings) → **Finance** → **Connect Stripe Account** → Choose to create new or connect existing Stripe account → Complete verification → Return to Every.
...
<CardGroup cols={2}>
  <Card
    ...
    icon="stripe"
    href="https://app.every.ai/settings/finance"
  >
