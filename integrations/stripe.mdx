...
Go to **Settings** → **Payments** → **Connect Stripe Account** → Choose to create new or connect existing Stripe account → Complete verification → Return to Every AI.
...
- Every AI invoice NOT automatically updated (void invoice or add note manually)
...
**PCI Compliance:** Automatic! Stripe handles all card data, no card details stored on Every AI servers.
