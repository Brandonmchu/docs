...
Go to [**Contacts**](https://app.every.ai/contacts) page → Click **Import** dropdown → Select **Google Contacts**
...
Open [**Contacts**](https://app.every.ai/contacts) → **Let Every import your contacts**.
...
**4. Warm Leads:**
Open [**Deals**](https://app.every.ai/) → **Find warm leads**. Every evaluates eligible contacts against the audience you describe and uses available Gmail and Calendar relationship evidence when ranking matches.
...
Disconnecting stops future Google access. It does not remove contacts, client records, or relationship activity that Every already added to your workspace.
...
<AccordionGroup>
  ...
  <Accordion title="What happens to imported contacts if I disconnect Google?">
    The Google connection stops working, but contacts and other records already imported into Every remain in your workspace until you edit or remove them there.
  </Accordion>
</AccordionGroup>
