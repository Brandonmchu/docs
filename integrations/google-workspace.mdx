...
Go to [**Agent Settings → Connections**](https://app.every.ai/agent/connections) → find the **Google Workspace** card → **Connect Google Account** → Select your Google account → Review permissions → Click Allow → Return to Every.
...
**3. Warm Leads:**
Open [**Pipeline**](https://app.every.ai/pipeline) → **Find warm leads**. Every evaluates eligible contacts against the audience you describe and uses available Gmail and Calendar relationship evidence when ranking matches.
