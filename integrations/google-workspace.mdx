...
After a client is created, open their record and choose **Actions → Enrich Client**. Every Agent uses Gmail, Calendar, and public web data to enrich the record; the same workflow is available via chat commands.
