...
Go to [**Agent → Connections**](https://every.ai/agent/connections) → find the **Google Workspace** card → **Connect Google Account** → Select your Google account → Review permissions → Click Allow → Return to Every.
...
Open the **Contacts** page → **Let Every import your contacts**
