...
When you first use an Every tool, Claude Code prompts you to authenticate via OAuth. Browser opens → sign in to Every → authorize → return to terminal.

**Verify:** Ask Claude "List my recent invoices"
