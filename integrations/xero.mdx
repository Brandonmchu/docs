...
**What happens:**
- Every Agent loses Xero access
- No data is deleted from either system
- CSV export to Xero format still works
...
<Tip>
  **Use Xero as source of truth** - If you connect Xero, treat it as your accounting system of record. Create invoices directly in Xero via agent or use CSV export.
</Tip>

<Tip>
  **Review before approving** - When creating invoices via agent, review the details before telling the agent to approve. Draft invoices can be edited in Xero.
</Tip>

<Tip>
  **Reconcile regularly** - Use Xero's bank reconciliation features alongside Every for complete financial management.
</Tip>

<Tip>
  **Check permissions** - Ensure your Xero user has appropriate permissions for the actions you want Every Agent to perform.
</Tip>
