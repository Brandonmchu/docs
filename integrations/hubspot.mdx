...
description: "Access HubSpot CRM data through Every Agent to manage contacts, companies, and deals conversationally"
icon: "hubspot"
---
...
**View Status:** Agent Settings → Integrations → HubSpot
...
**Solution:** Go to Agent Settings → Integrations → Reconnect HubSpot
