...
1. Go to [**Agent Settings → Connections**](https://app.every.ai/agent/connections)
...
<AccordionGroup>
  ...
  <Accordion title="Which system is the source of truth?">
    Keep HubSpot as the source of truth for HubSpot-owned CRM records. Every holds its own clients, contacts, warm leads, proposals, invoices, payments, expenses, and time records.
  </Accordion>
