...
<Note>
  Google Contacts **Import** brings in all your contacts. The **Scan Contacts** workflow on the Contacts page is different - it uses AI to identify which contacts look like potential business clients.
</Note>
...
**How it works:**
1. On the [**Contacts**](https://every.ai/contacts) page, click **Let Every import your contacts**
