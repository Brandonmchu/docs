...
**Setup:** Settings → Payments → Connect Stripe Account → Complete Stripe onboarding (business details, bank account, identity verification, tax info) → Return to Every
