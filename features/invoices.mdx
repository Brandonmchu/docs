...
Queue invoices to send automatically on a future date/time. Create invoice → Choose Schedule Send → Select date/time → System sends automatically. Editable until send time.

**Use Cases:** Month-end invoicing, project completion dates, client billing cycles

<Tip>
  **Ask Every Agent:** Schedule invoice sends:
  - "Schedule this invoice to send next Monday at 9am"
  - "Send the ACME Corp invoice on the 1st of next month"
</Tip>
