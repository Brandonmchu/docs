...
<Card title="Open Invoices" icon="file-text" href="https://every.ai/invoices" horizontal>
  View and manage all your invoices in Every
</Card>
...
Go to [**Invoices**](https://every.ai/invoices) → **Create Invoice** → Select client → Add line items → Set payment terms → Save as Draft or Send
...
<Tip>
  **Ask Every Agent:** Add line items easily:
  ...
  - "Include the web design service from my services at $2,500"
...
<Tip>
  **Use saved services/products and enable online payments** - Reusable line items speed up creation, and online payment options help clients pay significantly faster.
</Tip>
...
**Standard Invoicing:** Create invoice → Select client → Add saved services/products or manual line items → Review totals → Add notes/attachments → Send → Track delivery/opens → Receive payment → Record (or automatic if Stripe)
