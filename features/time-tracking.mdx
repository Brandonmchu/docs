...
**Manual Entry:** Time Tracking → Add Time Entry → Fill details (client, description, duration, rate) → Save
...
**Process:** Go to Time Tracking → Add Time Entry → Fill in client, description, start/end time (duration auto-calculates), hourly rate, and billable status → Save
