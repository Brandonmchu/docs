...
<Card title="Open Proposals" icon="file-check" href="https://every.ai/proposals" horizontal>
  View and manage all your proposals in Every
</Card>
...
**Create:** [**Proposals**](https://every.ai/proposals) → **Create Proposal** → Add client, title, line items, scope → Save as Draft or Send
...
Go to [**Proposals**](https://every.ai/proposals) → **Create Proposal** → Fill required fields (client, title, line items) and optional fields (scope, client message, media, attachments, terms, expiration) → Save as Draft or Send
...
**Line Items:** Same powerful system as invoices. Select from saved services or products for consistency, or create custom line items with description, quantity, rate, tax, and discounts.

<Tip>
  **Ask Every Agent:** Manage line items:
  - "Add a line item to this proposal: Website Design, $8,000"
  - "Include my 'Consulting Services' service in the proposal"
...
**Void** → Cancelled/declined/obsolete, preserved for history
...
<CardGroup cols={2}>
  ...
  >
    Create reusable services for proposals
  </Card>
</CardGroup>
