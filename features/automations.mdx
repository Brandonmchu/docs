...
<Card title="Open Automations" icon="repeat" href="https://every.ai/invoices/automations" horizontal>
  View and manage recurring invoice automations in Every
</Card>
...
Go to [**Automations**](https://every.ai/invoices/automations) → **Create Automation** → Configure these key fields:
...
<Tip>
  **Ask Every Agent:** To add or modify line items in automations:
  - "Add my 'Marketing Strategy' service to the ACME Corp automation"
...
| **Wrong amount** | Line item amounts, tax settings, discounts, saved service/product pricing | Edit automation, update amounts, verify pricing, re-test |
...
<CardGroup cols={2}>
  ...
  >
    Set up reusable services for automation line items
  </Card>
