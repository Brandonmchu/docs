...
Go to [**Settings**](https://every.ai/settings) → **Organization** → **Sales Tax Default** → Enter percentage (e.g., 13) → Save

**Common rates:** 5% (GST), 13% (ON/PEI HST), 15% (NS/NB/NL HST), 0% (exempt)

**Applied to:** New services, quick invoice creation, automation templates
...
Create or edit a service → Set **Tax Rate** → Save. Rate applies when that service is added to an invoice.
