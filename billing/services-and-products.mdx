...
description: "Build a reusable catalog of service templates and sellable products with structured pricing for invoices, proposals, bookings, and time tracking"
icon: "shapes"
---
...
- **[Invoices](/billing/invoices)** — add standard line items without retyping names and rates
- **[Proposals](/billing/proposals)** — reuse the same service pricing when quoting work
- **[Bookings](/scheduling/bookings)** — choose which services can be booked online
