...
<Card title="Open Expenses" icon="receipt" href="https://every.ai/expenses" horizontal>
...
Go to [**Expenses**](https://every.ai/expenses) → **Add Expense** → Fill required fields (merchant, amount, date) and optional fields (category, description, receipt, client) → Save
...
2. Go to [**Expenses**](https://every.ai/expenses) → **Add Expense** OR ask Every Agent "Log this receipt"
...
**Supported formats:** JPG, PNG, HEIC, GIF, WEBP (images), PDF, CSV, Excel (XLS, XLSX), Word (DOCX)
