...
<Card title="Open Recurring Billing" icon="repeat" href="https://every.ai/invoices/recurring-invoices" horizontal>
...
Go to [**Recurring Billing**](https://every.ai/invoices/recurring-invoices) → **Create Automation** → Configure these key fields:
