...
<Card title="Open Recurring Billing" icon="repeat" href="https://every.ai/invoices/automations" horizontal>
...
Go to [**Recurring Billing**](https://every.ai/invoices/automations) → **Create Automation** → Configure these key fields:
