...
<AccordionGroup>
  <Accordion icon="user-plus" title="Create a client">
    ...
    <Tip>After saving, open the client record and click the **Enrich** button to let Every Agent pull company details from Gmail, Calendar, and the public web. If you've already enriched a client, you can click the more options menu (⋮) and choose **Enrich Again**.</Tip>
  </Accordion>

  <Accordion icon="mail" title="Scan Google contacts (optional)">
