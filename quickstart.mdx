...
Set up your Every AI account and send your first invoice in 15 minutes.
...
<AccordionGroup>
  ...
  <Accordion icon="palette" title="Customize your branding">
    ...
    - **Invoice template** - Choose from professional designs
    - **Default notes** - Standard terms for all invoices
  </Accordion>
...
<AccordionGroup>
  <Accordion icon="user-plus" title="Create a client">
    ...
    <Tip>After saving, open the client record and choose **Actions → Enrich Client** to let Every Agent pull company details from Gmail, Calendar, and the public web.</Tip>
  </Accordion>

  <Accordion icon="google" title="Scan Google contacts (optional)">
    Connect Google in **Settings** → **Integrations**. On the **Home** dashboard, the **Get Started** card includes **Scan Contacts**, which runs Google Contacts Analysis across Gmail, Calendar, and Contacts. Review the suggestions and select the people you want to add as clients. You can trigger the same workflow by asking Every Agent to "scan my Google contacts and add the clients you find."
  </Accordion>
</AccordionGroup>
