...
<AccordionGroup>
  ...
  <Accordion icon="mail" title="Google Contact Scan Not Working">
    **Check:**
    ...
    - **Let Every import your contacts** button appears on the Contacts page
    - Contact exists in Google with an email address

    **Solutions:**
    1. Reconnect Google integration in **Agent → Connections**
    2. Re-run **Scan Contacts** from the Contacts page
...
<AccordionGroup>
  ...
  <Accordion icon="database" title="HubSpot Lookup Not Working">
    ...
    **Solutions:**
    1. Check connection in [**Agent → Connections**](https://every.ai/agent/connections)
  ...
  <Accordion icon="users" title="HubSpot Results Missing Expected Records">
    ...
    **Solutions:**
    ...
    2. Reconnect HubSpot in [**Agent → Connections**](https://every.ai/agent/connections)
