...
<AccordionGroup>
  <Accordion icon="search" title="Client Enrichment Not Finding Data">
    **Why It Happens:**
  ...
  <Accordion icon="trash-2" title="Can't Delete Client">
    **Reason:** Client has issued invoices and must be preserved for financial records
    ...
    **Solutions:**
    ...
    <Warning>Deleting clients with invoices can break financial reporting. Use archive instead.</Warning>
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion icon="trash-2" title="Can't Delete Payment">
...
<AccordionGroup>
  ...
  <Accordion icon="database" title="HubSpot Lookup Not Working">
    **Check:**
    - Connection status in **Agent Settings → Integrations**
    - HubSpot permissions were approved
    - Internet connection
    - HubSpot service status

    **Solutions:**
    1. Check connection in [**Agent Settings → Integrations**](https://every.ai/agent/settings/integrations)
  ...
  <Accordion icon="users" title="HubSpot Results Missing Expected Records">
    ...
    **Solutions:**
    ...
    2. Reconnect HubSpot in [**Agent Settings → Integrations**](https://every.ai/agent/settings/integrations)
...
<AccordionGroup>
  ...
  <Accordion icon="wrench" title="Agent Tool Not Working">
    ...
    **Solution:**
    ...
    - Create missing prerequisites (client, service, product, etc.)
  </Accordion>
</AccordionGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Common Workflows" icon="workflow" href="/workflows/common-workflows">
    Learn best practices and proven workflows
  </Card>
</CardGroup>
