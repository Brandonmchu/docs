...
<AccordionGroup>
  ...
  <Accordion icon="database" title="HubSpot Lookup Not Working">
    **Check:**
    - Connection status in **Agent Settings → Connections**
    - HubSpot permissions were approved
    - Internet connection
    - HubSpot service status

    **Solutions:**
    1. Check connection in [**Agent Settings → Connections**](https://every.ai/agent/connections)
  ...
  <Accordion icon="users" title="HubSpot Results Missing Expected Records">
    ...
    **Solutions:**
    ...
    2. Reconnect HubSpot in [**Agent Settings → Connections**](https://every.ai/agent/connections)
