...
description: "Solutions to common issues and problems in Every AI"
---
...
- **Home → Get Started → Scan Contacts** shows the button
...
- Record payment in Every AI manually
