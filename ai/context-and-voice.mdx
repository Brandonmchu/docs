...
description: "Review what Every knows about your business, shape its voice, and manage its standing rules in one workspace"
icon: "sliders"
---

## Overview

Every Agent does its best work when it understands two things about you: **what your business is**, and **how your business sounds**. Both live in [**Agent → Business DNA**](https://app.every.ai/agent/dna), alongside knowledge sources and rules.

- **Business DNA** — the structured facts about your business: what you do, what you sell, how you grow, what you measure, and how you operate.
- **Voice & Tone** — your writing style, tailored per audience, so drafts sound like you.

<Card title="Open Business DNA" icon="sliders" href="https://app.every.ai/agent/dna" horizontal>
  Manage Business DNA, voice, knowledge sources, and rules in one place
</Card>

<Note>
  Business DNA tells the agent **what is true** about your business. Voice & Tone tells it **how to express it**. Use both together.
</Note>

## Business DNA

Business DNA is the structured profile Every builds about how your business works. It combines editable fields with uploaded files, Google Drive references, and web links so the agent can answer questions and take action with better business-specific judgment.

**Use Business DNA for:**
...
Good Business DNA improves invoice and proposal drafting, business Q&A, data analysis, follow-up suggestions, and context-aware recommendations.
...
### Build DNA From Your Workspace

Business DNA can be generated from your existing workspace data. Use **Build DNA** or **Refresh DNA** when:
...
You can add files and links the agent should reference under **Knowledge sources** on the Business DNA tab.
...
Voice & Tone controls how Every Agent sounds when it drafts on your behalf. It's separate from Business DNA — facts vs. style — and lives in the **Voice & Tone** tab.
...
|-|-|
| **Business DNA** | Facts, operating model, services, products, and growth model |
| **Voice & Tone** | Style, tone, audience-specific communication patterns |

Business facts, the service catalog, operating model, and client segmentation logic belong in **Business DNA** — not Voice & Tone.
...
- **Rules** — standing instructions the agent saves with your confirmation (manage in [**Agent → Business DNA → Rules**](https://app.every.ai/agent/dna?tab=rules))
