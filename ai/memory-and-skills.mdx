...
<CardGroup cols={2}>
  ...
  <Card title="Agent Settings" icon="sliders" href="https://every.ai/agent/context" horizontal>
...
They reinforce each other: Memory tracks the loose ends, Preferences enforce hard rules, and [Business Context](/ai/context-and-voice) gives the big picture. Manage standing rules in [**Agent → Preferences**](https://every.ai/agent/preferences); manage Business Context in [**Agent → Context**](https://every.ai/agent/context).
...
- Use a [**Learned Preference**](/ai/every-agent) for a *single standing rule* ("ACME always gets Net 15")
- Use [**Business Context**](/ai/context-and-voice) for *what your business is* (services, pricing logic, who you serve)
