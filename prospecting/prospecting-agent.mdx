...
<Card title="Open Pipeline" icon="git-branch" href="https://every.ai/pipeline" horizontal>
...
You can put prospecting on autopilot as a recurring **Heartbeat** routine. The **Prospecting heartbeat** scans your network on a schedule (a daily local cadence by default) and surfaces new Pending deals for you to review — so warm opportunities keep showing up without you starting a scan each time.

Set it up from the prospecting card's heartbeat pill or from the Heartbeat hub. Scheduled runs bill credits like a manual run, and the goal is re-resolved on each run.

<Card title="Set up the Prospecting heartbeat" icon="heart-pulse" href="/heartbeat/heartbeat" horizontal>
...
<CardGroup cols={2}>
  ...
  <Card title="Heartbeat" icon="heart-pulse" href="/heartbeat/heartbeat">
